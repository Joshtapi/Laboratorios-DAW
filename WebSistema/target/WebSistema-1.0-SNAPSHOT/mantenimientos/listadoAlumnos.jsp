                    ...
                    <tbody>
                        <c:forEach items="${arrAlumnos}" var="alumno">
                            <tr>
                                ...
                                <td>
                                    <a href="/WebSistema/controladorPrincipal?accion=modificarAlumno&xcod=<c:out value='${alumno.codigo}'/>" class="btn btn-primary" style="background-color:#148F77">Editar</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>

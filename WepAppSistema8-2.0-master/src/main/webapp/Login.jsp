...
<html>
    ...
    <body>
        <form name="form" action="/WebAppSistema/ServletVerifica" method="post">
            <div class="contenedor">
                <div class="box-login shadow-lg border p-5 rounded">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <img src="recursos/IMG/skoy_color.png" alt="Logo" id="logoSkoy">
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-12">
                            <label class="mdc-text-field mdc-text-field--outlined w-100 text-field-pass">
                                ...
                                <input type="password" name="xcla" class="mdc-text-field__input toggle-password"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button class="btn btnLogin w-100 rounded-pill">INICIAR SESIÓN</button><br><br>
